"use client";
// frontend/src/auth/components/RegisterForm.jsx
...
const C = {
  ...
  white:"#FFFFFF", text1:"var(--inv-text1)",
    ...
    <div style={{ position:"relative", marginBottom: error?4:16 }}>
      <input
        ...
        style={{
          ...
          fontSize:14, color:"var(--inv-text1)",
      ...
      <div style={{ display:"flex", gap:4, marginBottom:5 }}>
        {[1,2,3,4].map(i=>(
          <div key={i} style={{
            ...
            background: i<=score?col:"rgba(255,255,255,.07)",
  ...
  const showHideBtn = (
    <button type="button"
      ...
      style={{
        ...
        fontSize:10, color:"var(--inv-text4)", fontWeight:800,
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .rbtn:hover:not(:disabled){background:linear-gradient(135deg,#F0D880,#C89A30)!important;transform:translateY(-1px);box-shadow:0 8px 28px rgba(232,201,122,.45)!important}
      ...
      <div style={{ width:"100%", maxWidth:440, animation:"fadeUp .45s ease both" }}>
        ...
        <div style={{
          ...
          {success ? (
            <div style={{ textAlign:"center", padding:"28px 0" }}>
              ...
              <p style={{ color:"var(--inv-text3)", fontSize:13, margin:0 }}>
                Redirecting you now…
              </p>
            </div>
          ) : (
            <>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:12, margin:"20px 0" }}>
                ...
                <span style={{ fontSize:11, color:"var(--inv-text4)", fontWeight:700, letterSpacing:".1em" }}>OR</span>
                <div style={{ flex:1, height:1, background:"rgba(255,255,255,.07)" }}/>
              </div>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                {errors.name && <p style={{fontSize:11,color:C.red,margin:"-10px 0 12px 2px",fontWeight:600}}>{errors.name}</p>}

                <FloatInput label="Email address" type="email" value={form.email}
                  onChange={e=>set("email",e.target.value)}
                  error={errors.email} autoComplete="email"/>
                {errors.email && <p style={{fontSize:11,color:C.red,margin:"-10px 0 12px 2px",fontWeight:600}}>{errors.email}</p>}

                <FloatInput label="Password" type={showPw?"text":"password"} value={form.password}
                  onChange={e=>set("password",e.target.value)}
                  error={errors.password} autoComplete="new-password"
                  rightSlot={showHideBtn}/>
                {errors.password && <p style={{fontSize:11,color:C.red,margin:"-10px 0 8px 2px",fontWeight:600}}>{errors.password}</p>}
                ...
                {errors.confirm && <p style={{fontSize:11,color:C.red,margin:"-10px 0 14px 2px",fontWeight:600}}>{errors.confirm}</p>}
                ...
                {/* Terms */}
                <p style={{ fontSize:11, color:"var(--inv-text4)", textAlign:"center", marginBottom:18, lineHeight:1.7 }}>
                  By registering you agree to our{" "}
                  <Link href="/terms" style={{ color:"var(--inv-text3)", textDecoration:"underline" }}>Terms</Link>
                  {" "}and{" "}
                  <Link href="/privacy" style={{ color:"var(--inv-text3)", textDecoration:"underline" }}>Privacy Policy</Link>.
                </p>
        ...
        {/* Footer */}
        <p style={{ textAlign:"center", marginTop:22, fontSize:13, color:"var(--inv-text3)" }}>
