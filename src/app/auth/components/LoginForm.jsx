      ...
      <div style={{ width:"100%", maxWidth:420, animation:"fadeUp .45s ease both" }}>
        ...
        <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12, margin:"22px 0" }}>
            ...
            <span style={{ fontSize:11, color:"var(--inv-text4)", fontWeight:700, letterSpacing:".1em" }}>
              OR
            </span>
            <div style={{ flex:1, height:1, background:"rgba(255,255,255,.07)" }}/>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ textAlign:"right", marginBottom:22 }}>
              <Link href="/forgot-password" className="llink"
                style={{ fontSize:12, color:"var(--inv-text3)", textDecoration:"none", transition:"color .2s" }}>
                Forgot password?
              </Link>
            </div>
